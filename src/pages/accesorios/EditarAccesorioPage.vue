    ...
    <div class="form-container">
        ...
        <div class="form-header">
            <div class="header-content">
                <h1 class="form-title">✏️ Editar Accesorio</h1>
                <p class="form-subtitle">Actualiza los detalles de este accesorio</p>
            </div>
        </div>
        ...
        <!-- Formulario -->
        <form v-else @submit.prevent="guardarAccesorio" class="form-content">
...
const cargarAccesorio = async () => {
    try {
        cargando.value = true;
        const response = await accesoriosStore.fetchAccesorioPorId(route.params.id);
        const data = response?.data || response;
        formData.value = {
            nombre: data.nombre || data.accesorio || '',
            descripcion: data.descripcion || '',
            precio: data.precio || data.precio_unitario || '',
        };
    } catch (err) {
        error.value = 'Error al cargar el accesorio';
        console.error(err);
    } finally {
...
const guardarAccesorio = async () => {
    ...
    try {
        ...
        await accesoriosStore.actualizarAccesorio(route.params.id, datos);
