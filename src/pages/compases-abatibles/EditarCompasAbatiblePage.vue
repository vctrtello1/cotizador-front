    ...
    <div class="form-container">
        ...
        <div class="form-header">
            <div class="header-content">
                <h1 class="form-title">✏️ Editar Compás Abatible</h1>
                <p class="form-subtitle">Actualiza los detalles de este compás abatible</p>
            </div>
        </div>
        ...
        <div v-if="cargando" class="loading-state">
            <p>Cargando compás abatible...</p>
        </div>

        <!-- Formulario -->
        <form v-else @submit.prevent="guardarCompas" class="form-content">
...
// Cargar compás
const cargarCompas = async () => {
    try {
        cargando.value = true;
        const response = await compasesStore.getCompasAbatibleByIdStore(route.params.id);
        ...
        error.value = 'Error al cargar el compás abatible';
        console.error(err);
    } finally {
...
const guardarCompas = async () => {
    ...
    try {
        ...
        await compasesStore.actualizarCompasAbatible(route.params.id, datos);
