...
const cargarAcabado = async () => {
    try {
        cargando.value = true;
        const response = await acabadosStore.fetchAcabadoPorId(route.params.id);
        const data = response?.data || response;
        formData.value = {
            nombre: data.nombre || data.acabado || '',
...
const guardarAcabado = async () => {
    ...
    try {
        ...
        await acabadosStore.actualizarAcabado(route.params.id, datos);
