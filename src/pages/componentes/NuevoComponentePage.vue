<template>
    <div class="nuevo-componente-container">
        <!-- Header -->
        <div class="page-header">
            <button class="btn-back" @click="$router.push('/componentes')">← Volver</button>
            <h1 class="page-title">Nuevo Componente</h1>
        </div>
        ...
        <!-- Formulario -->
        <div class="info-card">
            <h2 class="section-title">Información del Componente</h2>
            <div class="info-grid">
                ...
                <div class="form-group">
                    <label class="form-label">Código del Componente *</label>
                    <input 
        ...
        <div class="resumen-card">
            <h2 class="section-title">Resumen del Componente</h2>
        ...
        <div class="action-buttons">
            <button class="btn-secondary" @click="$router.push('/componentes')">Cancelar</button>
            <button 
                class="btn-primary" 
